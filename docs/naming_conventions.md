...
- **`<category>_<entity>`**  
  ...
  - `<entity>`: Descriptive name of the table, aligned with the business domain (e.g., `customers`, `products`, `sales_data`).  
  - Examples:
    - `dim_customers` → Dimension table for customer data.  
    - `fact_sales_data` → Fact table containing sales transactions.  
